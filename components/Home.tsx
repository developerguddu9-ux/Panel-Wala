...
interface HomeProps {
  ...
  // Added onNav to handle bottom navigation requests from App.tsx
...
const Home: React.FC<HomeProps> = ({ 
  ...
  const [userToDelete, setUserToDelete] = useState<DeviceInfo | null>(null);
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 md:px-6 flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-20 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-x-2">
                ...
                {user && (
                    <div className="flex items-center space-x-2 text-[10px] font-bold uppercase">
                        ...
                        <span className="text-app-green">{user.userType}</span>
                        <span className="text-gray-300">•</span>
                        <span className="text-blue-600">{user.keyType}</span>
                    </div>
                )}
            </div>
          </div>
        ...
        <div className="flex items-center space-x-2 md:space-x-3 w-full md:w-auto overflow-x-auto pb-1 md:pb-0 scrollbar-hide">
          ...
          <button onClick={() => setShowAdminModal(true)} className="p-3 text-gray-600 hover:text-purple-600 rounded-lg shrink-0" title="Settings">
      ...
      {/* Bottom Navigation for mobile users - fixes onNav mismatch in App.tsx */}
